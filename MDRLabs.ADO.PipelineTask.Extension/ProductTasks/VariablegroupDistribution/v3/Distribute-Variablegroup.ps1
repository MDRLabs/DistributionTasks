            ...
            try {
                ...
                if ($jsonObject.ValidJson) {
                    ...
                    foreach ($project in $Projects) {
                        ...
                        [string]$apiGetUri = Get-VariablegroupGetUrl -AdoServerUrl $ServerUrl -Project $project -GroupName $jsonObject.Name
                        ...
                        try{
                            ...
                            if ($vstsVariableGroup.count -eq 0) {
                                ...
                                [string]$ApiPostUri = Get-VariablegroupPostUrl -AdoServerUrl $ServerUrl -Project $project
                                ...
                                [string]$apiUpdateUri =  Get-VariablegroupPutUrl -AdoServerUrl $ServerUrl -Project $project -VariableGroupObjectId $variableGroupObject.id
