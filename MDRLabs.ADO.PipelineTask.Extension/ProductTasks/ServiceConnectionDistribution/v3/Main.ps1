...
Write-Verbose -Message ("Start Maintain Pipelines Serviceconnection execution")
...
[string]$ExcludeParam = @()
[string]$ServerUrl = "''"
[string]$Parameters = "-Token $Token -Comment '$Comment' "
...
$scriptFile = Join-Path -Path $PSScriptRoot -ChildPath "ServiceConnection-Distribution.ps1"
